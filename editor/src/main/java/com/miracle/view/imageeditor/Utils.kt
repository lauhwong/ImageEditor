...
object Utils {
    ...
    fun mapInvertMatrixTranslate(matrix: Matrix, dx: Float, dy: Float): FloatArray {
        ...
        val startX = Utils.getMatrixTransX(invertMatrix)
        val startY = Utils.getMatrixTransY(invertMatrix)
    ...
    fun mapInvertMatrixScale(matrix: Matrix, scaleX: Float, scaleY: Float): FloatArray {
        ...
        tempMatrix.set(matrix)
        tempMatrix.invert(invertMatrix)
        val startScaleX = Utils.geMatrixScale(invertMatrix)
        val startScaleY = Utils.geMatrixScale(invertMatrix)
